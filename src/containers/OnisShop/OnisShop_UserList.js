...
class Components extends Component {
                  ...
                  componentWillMount() {
                    ...
                    console.log("Districtinfo", this.props);
...
export default connect(mapStateToProps,{ getDeskStore, OnisUser, editDeskStore, clearBranch, editCustomer, getDistrict })(form(Components));
